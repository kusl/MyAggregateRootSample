...
public class ServiceCollectionExtensionsTests
{
    ...
    private static IConfiguration CreateConfiguration()
    {
...
} shippingAddress, billingAddress, orderItems);
        ...
        Assert.Equal(shippingAddress, savedCustomer.DefaultShippingAddress);
        Assert.Equal(billingAddress, savedCustomer.DefaultBillingAddress);
        Assert.Single(savedCustomer.Orders);
